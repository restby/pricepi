...
var getPriceData = exports.getPriceData = function getPriceData() {
  ...
  var itemsData = Object.keys(boatItems);
  console.log(itemsData);
  var catalogBoats = document.querySelector('[data-boats-slide]');
  ...
  catalogBoats.addEventListener('click', function (evt) {
    ...
    while (target && target !== catalogBoats) {
      if (target.getAttribute('data-open-modal')) {
        ...
        console.log("\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 \u0430\u0442\u0440\u0438\u0431\u0443\u0442\u0430 data-open-modal: ".concat(modalId));
        break;
      }
...
var _priceData = require("./buisness/priceData");
// import {Burger} from './modules/header/burger';
// import {Burger} from './modules/header/burger';
// import {Burger} from './modules/header/burger';
// ---------------------------------
window.addEventListener('DOMContentLoaded', function () {
  (0, _priceData.getPriceData)();
  // Utils
  // ---------------------------------
...
},{"./buisness/priceData":1,"./modules/header/burger":3,"./modules/initBiaxialSlider":7,"./modules/initBoatSlider":8,"./modules/initUniaxialSlider":9,"./modules/modals/init-modals":10,"./modules/tabs/init-tabs":12,"./utils/ios-vh-fix":16}],3:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":4,"./scroll-lock":6}],4:[function(require,module,exports){
"use strict";
...
},{"../vendor/swiper":18}],8:[function(require,module,exports){
"use strict";
...
},{"../vendor/swiper":18}],9:[function(require,module,exports){
"use strict";
...
},{"./ios-checker":15,"dup":6}],18:[function(require,module,exports){
