...
var initCardItem = exports.initCardItem = function initCardItem() {
  var body = document.querySelector('body');
  var templateFragment = document.querySelector('[data-modal-template]').content;
  // Находим фрагмент с содержимым темплейта
  var template = templateFragment.querySelector('[data-modal--preload]'); // В фрагменте находим нужный элемент
...
var _initCardItem = require("./buisness/initCardItem");
...
},{"./buisness/initCardItem":1,"./modules/header/burger":3,"./modules/initBiaxialSlider":7,"./modules/initBoatSlider":8,"./modules/initUniaxialSlider":9,"./modules/modals/init-modals":10,"./modules/tabs/init-tabs":12,"./utils/ios-vh-fix":16}],3:[function(require,module,exports){
"use strict";
