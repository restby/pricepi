  ...
  if (document.querySelector('[data-catalog__element]')) {
    ...
    catalogElements.forEach(function (el) {
      el.addEventListener('click', function (evt) {
        ...
        var targetValue = 'value2'; // Значение, с которым сравниваем ключи

        for (var key in myObject) {
          if (myObject.hasOwnProperty(key)) {
            // Убедимся, что ключ принадлежит самому объекту, а не его прототипу
            if (myObject[key] === targetValue) {
              console.log("\u041D\u0430\u0439\u0434\u0435\u043D \u043A\u043B\u044E\u0447 \u0441 \u043D\u0443\u0436\u043D\u044B\u043C \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435\u043C: ".concat(key));
            }
          }
        }
      });
