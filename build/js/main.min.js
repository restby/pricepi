...
var getPriceData = exports.getPriceData = function getPriceData() {
  var itemsData = Object.keys(_priceData.items);
  console.log(itemsData);
  if (document.querySelector('[data-catalog__element]')) {
    var catalogBoats = document.querySelectorAll('[data-catalog__element]');
    catalogBoats.forEach(function (el) {
      el.addEventListener('click', function (evt) {
        ...
        console.log("\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 itemDataValue \u0437\u0430 \u043F\u0440\u0435\u0434\u0435\u043B\u0430\u043C\u0438 \u0446\u0438\u043A\u043B\u0430: ".concat(itemDataValue));
      });
    });
  }
};
