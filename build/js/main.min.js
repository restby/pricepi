...
var changeImagesUrl = exports.changeImagesUrl = function changeImagesUrl(items, itemDataValue) {
    ...
    buttonsValue.forEach(function (buttonValue) {
      buttonValue.addEventListener('click', function () {
        ...
        if (buttonDataValue === 'noWheel') {
          sourceElement.setAttribute('srcset', "img/items/".concat(items[itemDataValue].itemImgFileNameStart, ".webp"));
          imgElement.setAttribute('src', "img/items/".concat(items[itemDataValue].itemImgFileNameStart, ".jpg"));
          var updatedAltText = altText.replace(imgElement.getAttribute('alt'), "".concat(items[itemDataValue].itemTitle, ", \u0444\u043E\u0442\u043E \u0431\u0435\u0437 \u043A\u043E\u043B\u0435\u0441"));
          imgElement.setAttribute('alt', updatedAltText);
        }
        if (buttonDataValue === 'wheel2R13') {
          sourceElement.setAttribute('srcset', "img/items/".concat(items[itemDataValue].itemImgFileNameWheel2R13, ".webp"));
          imgElement.setAttribute('src', "img/items/".concat(items[itemDataValue].itemImgFileNameWheel2R13, ".jpg"));
          var _updatedAltText = altText.replace(imgElement.getAttribute('alt'), "".concat(items[itemDataValue].itemTitle, ", \u0444\u043E\u0442\u043E \u0441 2 \u043A\u043E\u043B\u0435\u0441\u0430\u043C\u0438 R13"));
