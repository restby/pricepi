    ...
    catalogElements.forEach(function (el) {
      el.addEventListener('click', function (evt) {
        ...
        if (_priceData.items.hasOwnProperty(itemDataValue)) {
          var itemDataObject = _priceData.items[itemDataValue];
          var keys = Object.keys(itemDataObject);
          var values = Object.values(itemDataObject);
          console.log('Keys:', keys);
          console.log('Values:', values);
        } else {
          console.log('Ключ не найден');
        }
        var modalItem = document.querySelector("[data-modal=".concat(itemDataValue, "]"));
